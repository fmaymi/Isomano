...
\subsection{Embedasploit} \label{embd}%I'm liking this section. Now to get everything else to this point...
...
\subsection{Concolic Testing and angr} \label{conc} %Expand
...
\subsection{Econotag} \label{etag}%Short but I'm REALLY having a hard time finding information on econotag or its base system
...
\subsection{Results} \label{rslt} %Work on time stuff
...
\section{Related Work} \label{rltd} %This section is looking a bit beat up after taking much of it for use in the intro. Need to rework
